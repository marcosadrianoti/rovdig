...
import br.com.ciac.rovd.entidade.Carro;
import br.com.ciac.rovd.util.FabricaConexaoCarro;
...
public class CarroDAO {
    ...
    public void salvar(Carro carro) throws ErroSistema{
        try {
            Connection conexao = FabricaConexaoCarro.getConexao();
            ...
            ps.execute();
            FabricaConexaoCarro.fecharConexao();
